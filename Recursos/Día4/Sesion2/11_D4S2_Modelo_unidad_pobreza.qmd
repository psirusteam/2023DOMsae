...
El resultado indican la proporción de personas por debajo de la linea de probreza  `r round(temp_ing$mrp_estimate,2)` lineas de pobreza
...
El resultado nos indica que la tasa de pobreza en la dam 01 es `r round(temp_dam01$mrp_estimate,2)`
...
El resultado nos indica que la tasa de pobreza en la dam2  05001 es `r round(temp_dam2_00203$mrp_estimate,2)`
